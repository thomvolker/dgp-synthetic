...
Dataset with movie ratings provided by Netflix: movie rating (1-5); submission date (within 14 days)

:::{.fragment}

:::{.emph}

Narayanan & Shmatikov ([2008](https://systems.cs.columbia.edu/private-systems-class/papers/Narayanan2008Robust.pdf)) identified 99% of the records

- 8 movie ratings of which 2 were allowed to be incorrect, and dates within a 2 weeks margin.

- Linking to [International Movie Database](https://imdb.com)
...
__Software__: [Synthetic Data Vault (sdv)](https://github.com/sdv-dev/sdv)^[Patki, Wedge & Veeramachaneni, K. (2016): [https://github.com/sdv-dev/sdv](https://github.com/sdv-dev/sdv)], [synthcity](https://github.com/vanderschaarlab/synthcity)^[Qian, Cebere & van der Schaar (2023): [https://github.com/vanderschaarlab/synthcity](https://github.com/vanderschaarlab/synthcity)]; [RGAN](https://github.com/mneunhoe/RGAN)^[Neunhoeffer (2026): [https://github.com/mneunhoe/RGAN](https://github.com/mneunhoe/RGAN)].
...
- Sensitivity: bounds the maximum influence a single individual can have on a model
...
- __Sensitivity__: Altering one individual affects our estimate with at most $1$
...
- Tutorial: Volker (2025). Genearting and evaluating synthetic data in R. LMU Open Science Center. [https://doi.org/10.5281/zenodo.18318778](https://doi.org/10.5281/zenodo.18318778)
